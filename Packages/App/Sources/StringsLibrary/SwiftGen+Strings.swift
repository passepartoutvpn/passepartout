...
public enum Strings {
  ...
  public enum Errors {
    public enum App {
      ...
      /// Unable to start web receiver. Make sure that your TV is properly connected to the local network.
      public static let webReceiver = Strings.tr("Localizable", "errors.app.web_receiver", fallback: "Unable to start web receiver. Make sure that your TV is properly connected to the local network.")
