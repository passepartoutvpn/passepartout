  ...
  internal enum Settings {
    ...
    internal enum Sections {
      internal enum Icloud {
        ...
        internal static let footer = L10n.tr("Localizable", "settings.sections.icloud.footer", fallback: "To erase the iCloud store securely, do so on all your synced devices. This will not affect local profiles.")
      }
    }
  }
