...
public class WebServices {
    ...
    public enum Endpoint: Convenience.Endpoint {
        ...
        case providerNetwork(InfrastructureName)
        ...
        public var url: URL {
            return AppConstants.Services.apiURL(version: AppConstants.Services.version, path: path)
        }
    }
    ...
    public func providerNetwork(with name: InfrastructureName, ifModifiedSince lastModified: Date?, completionHandler: @escaping (Response<Infrastructure>?, Error?) -> Void) {
